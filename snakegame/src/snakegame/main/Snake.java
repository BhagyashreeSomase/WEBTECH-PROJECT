...
import snakegame.main.Snake.main.Main;

import java.awt.*;
	import java.awt.event.WindowEvent;
	import java.util.ArrayList;
import static snakegame.main.Rectangle.rec_height;
import static snakegame.main.Rectangle.rec_width;
	public class Snake extends JPanel {
	    ...
	    public void addPart() {
	        ...
	        switch (this.direction) {
	            case "right" -> this.body.add(new Rectangle(last.getPosx() - WIDTH, last.getPosy()));
	            case "left" -> this.body.add(new Rectangle(last.getPosx() + WIDTH, last.getPosy()));
	            case "up" -> this.body.add(new Rectangle(last.getPosx() , last.getPosy() + WIDTH));
	            case "down" -> this.body.add(new Rectangle(last.getPosx(), last.getPosy()  - WIDTH));
	        }
	    }
